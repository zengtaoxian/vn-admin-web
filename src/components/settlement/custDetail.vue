...
<template>
  <div class="box" ref="box">
    <div class="main_header clear">
      ...
      <div v-if="check_perm(75)" class="input_wrap" style="width: 300px;">
        <i-input placeholder="支持模糊搜索" style:
      ...
      <div v-if="check_perm(76)" class="export_btn" @click="showExportModal"></div>
      ...
      <!--<div class="select_mod_definition">-->
      <!--<Poptip placement="bottom" class="select_modal_w">-->
      <!--<Button>下边</Button>-->
      <!--<div slot="title">-->
      <!--<div class="select_title_top">-->
      <!--<span class="check_box"><el-checkbox :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange">全选</el-checkbox></span>-->
      <!--<span class="check_rest">重置</span>-->
      <!--</div>-->
      <!--</div>-->
      <!--<div slot="content">-->
      <!--<div class="select_mod_content">-->
      <!--<el-checkbox-group v-model="checkedCities" @change="handleCheckedCitiesChange">-->
      <!--<div class="check_line_group" v-for="city in cities">-->
...
//  },
      ...
      exportData() {
        ...
        api.DownLoadFile({
          url: '/vcloud/settlementCenter/saleDeptReport/custDetailExcel', data: {
      ...
      getList(beginDate, endDate) {
        this.loading = true;
        api.fetch_custDetail_report_info(
          {
            condition: this.condition,
