...
<template>
  <div class="box" ref="box">
    <div class="main_header header_border clear">
      <div v-if="check_perm(93)" class="input_wrap">
        <i-input placeholder="商品编号/供应商名称/供应商编号/供应商邮箱" style:
      ...
      <div v-if="check_perm(94)" class="export_btn" @click="showExportModal"></div>
  ...
  <div class="box" ref="box">
    <div class="main_header header_border clear">
      <div class="input_wrap">
        <i-input placeholder="商务名称\商务部门\商品编号\供应商" icon="search" style: @on-change="search"
    ...
    <Tabs v-model="timeChangevalue" :name="timeChangevalue" Col="100px" width="100px" @on-click="tabChange()" :animated="animated">
      <TabPane label="日报表" name="day">
        <Row>
          <Col span="24">
            <div class="tab_wrap">
              <Table :columns="tabHead" :data="listData" :height="tabHeight" :loading="loading"></Table>
            </div>
          </Col>
        </Row>
      </TabPane>
...
//        purviewArr: perm_info,
    ...
    methods: {
      ...
      exportData() {
        ...
        api.DownLoadFile({
          url: '/vcloud/settlementCenter/commDeptReport/commExcel', data: {
      ...
      getList(beginDate, endDate) {
        this.loading = true;
        api.fetch_commerce_report_info(
          {
            condition: this.condition,
