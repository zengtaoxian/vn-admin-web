...
<template>
  <div class="box" ref="box">
    <div class="main_header clear">
      ...
      <div v-if="check_perm(83)" class="input_wrap" style="width: 300px;">
      ...
      <div v-if="check_perm(84)" class="export_btn" @click="showExportModal"></div>
  ...
  export default {
    ...
    methods: {
      ...
      exportData() {
        ...
        api.DownLoadFile({
          url: '/vcloud/settlementCenter/saleDeptReport/saleDetailExcel', data: {
      ...
      getList(beginDate, endDate) {
        this.loading = true;
        api.fetch_salesDetail_report_info(
          {
            condition: this.condition,
