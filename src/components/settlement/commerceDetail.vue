...
<template>
  <div class="box" ref="box">
    <div class="main_header clear">
      ...
      <div v-if="check_perm(91)" class="input_wrap" style="width: 300px;">
      ...
      <div v-if="check_perm(92)" class="export_btn" @click="showExportModal"></div>
  ...
  export default {
    ...
    methods: {
      ...
      exportData() {
        ...
        api.DownLoadFile({
          url: '/vcloud/settlementCenter/commDeptReport/commDetailExcel', data: {
      ...
      getList(beginDate, endDate) {
        this.loading = true;
        api.fetch_commerceDetail_report_info(
          {
            condition: this.condition,
