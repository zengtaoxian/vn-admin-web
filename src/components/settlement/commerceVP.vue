...
<template>
  <div class="box" ref="box">
    <div class="main_header header_border clear">
      <div v-if="check_perm(246)" class="input_wrap" style="width: 400px;">
      ...
      <div v-if="check_perm(247)" class="export_btn" @click="showExportModal"></div>
  ...
  <!-- <div class="box" ref="box">
    <div class="main_header header_border clear">
      <div class="input_wrap">
        <i-input placeholder="商务名称\商务部门\订单编号\供应商" icon="search" style: @on-change="search"
...
//        purviewArr: perm_info,
    ...
    methods: {
      ...
      exportData() {
        ...
        api.DownLoadFile({
          url: '/vcloud/settlementCenter/commDeptReport/commVPExcel', data: {
      ...
      getList() {
        this.loading = true;
        api.fetch_commerce_vp_report_info(
          {
            condition: this.condition,
            category: this.timeChangevalue,
