...
<template>
  <div class="box">
    <div class="main_header clear">
      <div class="input_wrap" v-if="havePerm('233')">
      ...
      <table class="new_table">
        ...
        <tr class="tba_content" v-for="(item,index) in listData">
          ...
          <td class="pad_lf">
            ...
            <span v-if="havePerm('195') && item.status == '下架'">
              <Poptip
                transfer
                placement="top-end"
                confirm
            ...
            <span v-if="havePerm('196') && item.status == '上架'">
              <Poptip
                transfer
                placement="top-end"
                confirm
            ...
            <span class="tab_del_btn" @click="editPricel(item.id)" v-if="item.onTime == '' && havePerm('203')">编辑</span>
    ...
    <Modal class="vertical-center-modal" :mask-closable="false" v-model="modal1" title="新增销售价格包"
            ...
            <TabPane label="基本资料" name="tab1">
              <div class="tab_content">
                ...
                <div class="tab_line clear">
                  ...
                  <p class="tab_line_right" v-html="priceMap.remark" title="priceMap.remark"></p>
                </div>
                <div class="tab_line clear">
    ...
    <!-- 编辑开始 -->
    <Modal class="vertical-center-modal" :mask-closable="false" v-model="modalEdit" title="编辑销售价格包"
                ...
                <tr v-show="formValidate.callOutFeeType == '0' " class="tab_content">
                  ...
                  <th class="text_left pad_lt" width="310">
                    <el-radio-group v-model="formValidate.callOutInNetBillType">
                      <div>
                        <el-radio class="el_radio_box" label="1">长市合一1</el-radio>
                      </div>
...
//                this.formValidate.packageType = "2";
//                this.formValidate.goodType = 2;
//                this.formValidate.supplyType = "1";
//                this.formValidate.eType = "2";
//                this.formValidate.chargeType = "1"
