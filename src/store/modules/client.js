...
const actions = {
  //添加角色信息
  add_info: ({commit}, data) => new Promise((reslove, reject) => {
    let menuIds = [];
    let f = function (r) {
      if (r.checked) {
  ...
  //删除信息
  del_info: ({commit}) => new Promise((reslove, reject) => {
    let data = {
  ...
  //修改信息
  mdf_info: ({commit}) => new Promise((reslove, reject) => {
    let menuIds = [];
    let f = function (r) {
      if (r.checked) {
        menuIds = menuIds.concat(r.menuId);
  ...
  //获取信息
  get_info: ({commit}, data) => new Promise((resolve, reject) => {
  ...
  //获取列表
  get_list: ({commit}, data) => new Promise((reslove, reject) => {
  ...
  //重置信息
  reset_info: ({commit}) => new Promise((reslove, reject) => {
    let role_info = {
      createTime: '',
      roleId: '',
      roleName: '',
