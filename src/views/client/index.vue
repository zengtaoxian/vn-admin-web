<template>
  <div class="app-container">
    <list-template :searchPlace="searchPlace" :searchInput="searchInput" :dataList="dataList" :tableHead="tableHead"
                   :itemDisplay="itemDisplay" :itemTitle="itemTitle" :loading="loading" :dataInfo="dataInfo" :formRules="formRules"
                   ...
                   @deleteItem="deleteItem" @formReset="formReset" @formSubmit="formSubmit" @pageSizeChange="pageSizeChange"
                   @pageChange="pageChange">
      <template v-slot:addDataInfo>
